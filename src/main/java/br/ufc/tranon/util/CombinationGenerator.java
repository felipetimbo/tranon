 ...
 * https://github.com/dwdyer/uncommons-maths/blob/master/core/src/java/main/org/uncommons/maths/combinatorics/CombinationGenerator.java
...
public class CombinationGenerator<T> implements Iterable<List<T>>
{
    ...
    public static void main(String[] args) {
    	...
    	CombinationGenerator<Long> g = new CombinationGenerator<Long>(list, 2);
    	for (List<Long> c : g)
    	 {
